...
import { IoArrowBack, IoCamera, IoChevronForward, IoLogOut, IoLockClosed, IoNotifications, IoHelpCircle, IoLanguage, IoPerson, IoWallet } from 'react-icons/io5'
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                ...
                <p className="text-xs text-text-muted">Balance, top up & transactions</p>
              </div>
            </div>
