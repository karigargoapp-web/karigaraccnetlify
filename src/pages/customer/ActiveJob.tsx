          ...
          <div className="bg-white w-full max-w-[430px] rounded-t-3xl p-6 animate-slide-up">
            ...
            <div className="space-y-2 mb-5">
              ...
              <div className="flex justify-between text-sm font-semibold border-t border-border pt-3">
                <span>You Pay</span><span className="text-primary text-base">PKR {total}</span>
              </div>
              <div className="flex justify-between text-sm"><span className="text-text-secondary">Platform Commission (10%)</span><span className="font-medium text-red-500">- PKR {platformFee}</span></div>
              <div className="flex justify-between text-sm"><span className="text-text-secondary">Worker Receives</span><span className="font-medium text-green-600">PKR {total - platformFee}</span></div>
            </div>
