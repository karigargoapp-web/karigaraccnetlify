...
import { IoHome, IoBriefcase, IoWallet, IoPerson, IoLocation, IoCalendar, IoCash, IoChatbubbleEllipses, IoWarning, IoTime } from 'react-icons/io5'
    ...
    <div className="min-h-screen bg-surface flex flex-col">
      ...
      <div className="top-bar">
        ...
        {user?.approval_status === 'pending' && (
          <div className="mb-3 bg-amber-400/20 border border-amber-300/40 rounded-xl px-4 py-3 flex items-start gap-2">
        ...
        {user?.approval_status === 'rejected' && (
          <div className="mb-3 bg-red-500/20 border border-red-300/40 rounded-xl px-4 py-3 flex items-start gap-2">
              ...
              <div className="p-4">
                ...
                <div className="flex flex-wrap gap-3 text-xs text-text-muted">
                  <span className="flex items-center gap-1">
                    <IoCash size={14} className="text-text-muted" /> Inspection-first
                  </span>
                  <span className="flex items-center gap-1">
