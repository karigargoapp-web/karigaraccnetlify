...
import { IoArrowBack, IoCamera, IoChevronForward, IoLogOut, IoStar, IoCheckmarkCircle, IoLockClosed, IoHelpCircle, IoNotifications, IoLanguage, IoPerson, IoWallet } from 'react-icons/io5'
    ...
    <div className="min-h-screen bg-[#f5f5f5] flex flex-col">
      ...
      <div className="flex-1 px-5 py-5 space-y-4 overflow-y-auto pb-8">
        ...
        <div className="bg-white rounded-2xl shadow-sm overflow-hidden mb-4">
          ...
          {/* Wallet Row */}
          <button
            onClick={() => nav('/worker/wallet')}
            className="w-full flex items-center justify-between px-5 py-3.5 border-t border-border"
          >
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-full bg-green-50 flex items-center justify-center">
                <IoWallet size={18} className="text-primary" />
              </div>
              <div className="text-left">
                <p className="text-sm font-medium text-text-primary">My Wallet</p>
                <p className="text-xs text-text-muted">Balance, earnings & transactions</p>
              </div>
            </div>
