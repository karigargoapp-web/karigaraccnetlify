        ...
        <div className="bg-white rounded-2xl shadow-sm p-5 space-y-3">
          ...
          <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-xl">
            ...
            <div>
              ...
              <p className="text-sm font-semibold text-primary">Inspection-first pricing</p>
            </div>
          </div>
        </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="flex items-center border border-border rounded-xl overflow-hidden">
                  ...
                  <input
                    type="number"
                    placeholder="Enter inspection charges (max ₨500)"
                ...
                {overMax && (
                  <p className="flex items-center gap-1 text-xs text-danger mt-1">
                    <IoWarning size={13} /> Maximum inspection charge is ₨500
                  </p>
                )}
